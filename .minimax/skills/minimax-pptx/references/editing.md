...
4. **Build presentation** (do this in one coordinated structural pass):
...
5. **Edit content**: Update text in each `slide{N}.xml`.
   Slides are separate XML files, so a runtime that supports parallel file work may split this phase by slide after structural changes are complete. Do not assume any specific CLI for spawning workers.
...
**Parallel editing:** If the runtime supports parallel file work, split by slide file here (after completing step 4). Include:
- The slide file path(s) to edit
- **"Use the runtime's precise file-editing capability for all changes"**
...
**Use a precise file-editing capability, not broad sed-style replacement.** Precise edits force specificity about what to replace and where, yielding better reliability.
...
Some file-editing runtimes normalize smart quotes to ASCII. **When adding new text with quotes, use XML entities:**
